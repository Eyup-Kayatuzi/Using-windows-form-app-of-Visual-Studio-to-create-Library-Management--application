...
namespace KütüphaneOtomasyon.Model
{
    public class Kisi
    {
        ...
        public void setOlusturmaTarih(DateTime olusturmaTarih) { this.olusturmaTarih = olusturmaTarih; }
        public DateTime getOlusturmaTarih() { return this.olusturmaTarih; }
        public void setKullaniciAdi(string kullaniciAdi) { this.kullaniciAdi = kullaniciAdi; }
        public string getKullaniciAdi() { return this.kullaniciAdi; }
        public void setSifre(string sifre) { this.sifre = sifre; }
        public string getSifre() { return this.sifre; }
        public void setYetki(string yetki) { this.yetki = yetki; }
        public string getYetki() { return this.yetki; }
